            ...
            <div class="widget">
                ...
                <div class="tab_container">
                   ...
                   <div class="formRow">
                    ...
                    <div class="formRow">
                        <label for="param_name" class="formLeft">Số lượng: (kg)</label>
                        <div class="formRight">
                            <span class="oneTwo">
                                <input type="radio" id="param_total" name="total">
                            </span>
                        </div>
                        <div class="clear"></div>
                    </div>
                    ...
                    <div class="formRow">
                        ...
                        <div class="formRight">
                            <span class="oneTwo">
                                <input type="radio" id="param_is_home" value="0" name="is_home" checked="true"> Không <br/>
                                <input type="radio" id="param_is_home" value="1" name="is_home"> Có
                            </span>
                        </div>
                        <div class="clear"></div>
                    </div>
