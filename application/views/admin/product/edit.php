            ...
            <div class="widget">
                ...
                <div class="tab_container">
                 ...
                 <div class="formRow">
                    ...
                    <div class="formRow">
                        <label for="param_name" class="formLeft">Số lượng:<span class="req">(Kg)</span></label>
                        <div class="formRight">
                            <span class="oneTwo"><input type="text" _autocheck="true" id="param_total" value="<?php echo $product->total?>" name="total"></span>
                        </div>
                        <div class="clear"></div>
                    </div>

                     <div class="formRow">
                        <label for="param_name" class="formLeft">Hiển thị ở trang chủ:</label>
                        <div class="formRight">
                            <span class="oneTwo">
                                <input type="radio" id="param_is_home" value="0" <?php if($product->is_home==0){echo "checked";}?> name="is_home"> Không <br/> 
                                <input type="radio" id="param_is_home" value="1" <?php if($product->is_home==1){echo "checked";}?> name="is_home"> Có
                            </span>
                        </div>
                        <div class="clear"></div>
                    </div>
