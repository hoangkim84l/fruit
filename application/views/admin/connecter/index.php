...
<div id="main_connecter" class="wrapper">
	<div class="widget">
		...
		<table width="100%" cellspacing="0" cellpadding="0" id="checkAll" class="sTable mTable myTable">
			...
			<thead class="filter"><tr><td colspan="9">
				<form method="get" action="<?php echo admin_url('connecter')?>" class="list_filter form">
					<table width="80%" cellspacing="0" cellpadding="0"><tbody>
						...
						<tr>
							...
							<td style="width:150px">
								...
								<input type="reset" onclick="window.location.href = '<?php echo admin_url('connecter')?>'; " value="Reset" class="basic">
							</td>
				...
				<tr>
					<td colspan="9">
						<div class="list_action itemActions">
							<a url="<?php echo admin_url('connecter/delete_all')?>" class="button blueB" id="submit" href="#submit">
					...
					<tr class="row_<?php echo $row->id?>">
						...
						<td class="textC">
							<div class="image_thumb">
								<img height="50" src="<?php echo base_url('upload/connecter/'.$row->image_link)?>">
								<div class="clear"></div>
							</div>
						...
						<td class="option textC">
							<a class="tipS" title="Chỉnh sửa" href="<?php echo admin_url('connecter/edit/'.$row->id)?>">
								<img src="<?php echo public_url('admin/images')?>/icons/color/edit.png">
							</a>
							<a class="tipS verify_action" title="Xóa" href="<?php echo admin_url('connecter/del/'.$row->id)?>">
