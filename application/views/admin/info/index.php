...
<div id="main_info" class="wrapper">
	<div class="widget">

		<div class="title">
			<span class="titleIcon"><input type="checkbox" name="titleCheck" id="titleCheck"></span>
			<h6>
				Danh sách Giới thiệu & Hướng dẩn mua hàng
			</h6>
		...
		<table width="100%" cellspacing="0" cellpadding="0" id="checkAll" class="sTable mTable myTable">
			...
			<thead class="filter"><tr><td colspan="6">
				<form method="get" action="<?php echo admin_url('info')?>" class="list_filter form">
					<table width="80%" cellspacing="0" cellpadding="0"><tbody>
						...
						<tr>
							...
							<td style="width:150px">
								...
								<input type="reset" onclick="window.location.href = '<?php echo admin_url('info')?>'; " value="Reset" class="basic">
							</td>
				...
				<tr>
					<td colspan="6">
						<div class="list_action itemActions">
							<a url="<?php echo admin_url('info/delete_all')?>" class="button blueB" id="submit" href="#submit">
				...
				<?php foreach ($list as $row):?>
					<tr class="row_<?php echo $row->id?>">
						...
						<td class="option textC">
							<a class="tipS" title="Chỉnh sửa" href="<?php echo admin_url('info/edit/'.$row->id)?>">
